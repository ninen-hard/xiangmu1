...
//  合约地址
const MYNFT_ADDRESS = "0xc31fDAcb0E6e03548C417f2bDF2d1c7DC4BB3aE6";
const MARKET_ADDRESS = "0x0D18694aac3b30F90FA0B005BF47331cf8e98425";
      ...
      <div class="left-content">
        <div class="mint-nft-section">
          ...
          <input
            ...
            class="input-field"
          />
          <button onClick={mintNFT} disabled={loading} class="btn-mint">
            {loading ? 'Minting...' : 'Mint NFT'}
          </button>
        </div>
        <div class="list-nft-section">
          <h2>出售NFT</h2>
          <input
            type="number"
          ...
          <input
            ...
            class="input-field"
          />
          <button onClick={listNFTForSale} disabled={loading} class="btn-list">
            {loading ? 'Listing...' : 'List NFT'}
          </button>
        </div>
        <div class="on-sale-nfts-section">
          <h2>正在出售的NFT</h2>
          {nftsForSale.length === 0 ? (
            <p>无NFT出售中</p>
          ) : (
            <ul class="nfts-for-sale-list">
              {nftsForSale.map(({ tokenId, price, metadata }) => (
                <li key={tokenId.toString()} class="nft-for-sale-item">
                  <div class="nft-gallery__listBox">
                    <div class="nft-gallery__listImg">
                      <img src={metadata.image} alt={metadata.name} />
                    </div>
                    <div class="nft-gallery__listTitle">
                      <h3>{metadata.name}</h3>
                    </div>
                    <div class="nft-gallery__listRemark">
                      <p>Price: {price.toString()} ETH</p>
                    </div>
                    <div class="nft-gallery__listBtnBox">
                      <button
          ...
          {userNFTs.length === 0 ? (
            ...
            <div class="nft-gallery">
              {userNFTs.map(({ tokenId, metadata }) => (
                <div class="nft-gallery__listBox" key={tokenId.toString()}>
                  <div class="nft-gallery__listImg">
                    <img src={metadata.image} alt={metadata.name} />
                  </div>
                  <div class="nft-gallery__listTitle">
                  ...
                  <div class="nft-gallery__listBtnBox">
                    <button
                      ...
                      disabled={loading}
                      className="btn-remove-from-sale"
                    >
